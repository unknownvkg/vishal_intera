...
<body>
        ...
        <div id="revolution-slider1" class="rev_slider" data-version="5.4.4" style="display: none;">
          <ul>
            <li data-transition="fade" data-slotamount="7" data-masterspeed="2200" data-delay="6000">
              <!--  BACKGROUND IMAGE -->
              <img alt="Slide 1" src="img/slide-01.jpg">
              ...
              <a href="contact.html" class="tp-caption au-btn au-btn--big au-btn--pill au-btn--yellow au-btn--slide" data-x="center" data-y="['506', '390', '390', '310']"
      ...
      <div class="service-wrap">
        <div class="service__item service__intro" style="background-image: url('img/service-01.jpg');">
          <div class="service__item-inner">
            ...
            <div>
              <a href="about-us.html" class="au-btn au-btn--big au-btn--pill au-btn--white au-btn--border au-btn--big">See more</a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-5 col-md-12">
            <div class="blog-single">
              <div class="img-blog">
                <a href="blog-list.html">
                  <img alt="Blog 1" src="img/blog-single-01.jpg">
              ...
              <div class="blog-content">
                <h4 class="blog-title">
                  <a href="blog-list.html">design is thinking make visual</a>
                </h4>
                ...
                <p>
                  Sed ut perspiciatis unde omnis iste natus error sit voluptatem illution accusantium doloremque laudantium, totam.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-7 col-md-12">
            <div class="blog-item">
              <div class="row">
                <div class="col-md-5 col-12">
                  <div class="img-blog">
                    <a href="blog-list.html">
                      <img alt="Blog 2" src="img/blog-01.jpg">
                      <div class="date">
                        <div class="date__inner">
                          <span class="day">24</span>
                          <span class="month">dec</span>
                ...
                <div class="col-md-7 col-12">
                  <div class="blog-content">
                    <h4 class="blog-title">
                      <a href="blog-list.html">the detail are not the detail , they make the design</a>
                    </h4>
                    <p class="author">
                      <em>by Anthony Lee</em>
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                      Ut enim ad minim veniam, quis nostrud exercitation ullamco labequat.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <!-- End blog item   -->
            <div class="blog-item m-t-50">
              <div class="row">
                <div class="col-md-5 col-12">
                  <div class="img-blog">
                    <a href="blog-list.html">
                      <img alt="Blog 3" src="img/blog-02.jpg">
                      <div class="date">
                        <div class="date__inner">
                ...
                <div class="col-md-7 col-12">
                  <div class="blog-content">
                    <h4 class="blog-title">
                      <a href="blog-list.html">5 things will make your room more beautiful</a>
                    </h4>
                    <p class="author">
                      <em>by Keone Madrid</em>
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                      Ut enim ad minim veniam, quis nostrud exercitation ullamco labequat.
            ...
            <div class="blog-item m-t-50">
              <div class="row">
                <div class="col-md-5 col-12">
                  <div class="img-blog">
                    <a href="blog-list.html">
                      <img alt="Blog 4" src="img/blog-03.jpg">
                      <div class="date">
                        <div class="date__inner">
                ...
                <div class="col-md-7 col-12">
                  <div class="blog-content">
                    <h4 class="blog-title">
                      <a href="blog-list.html">the best design projects are the ones where people broke the rules</a>
                    </h4>
                    <p class="author">
                      <em>by Ian Eastwood</em>
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                      Ut enim ad minim veniam, quis nostrud exercitation ullamco labequat.
            ...
            <!-- End blog item   -->
            <div class="see-more">
              <a href="blog-list.html" class="au-btn au-btn--big au-btn--pill au-btn--yellow au-btn--white">See More</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="{{ asset('vendor/revolution/jquery.themepunch.revolution.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('vendor/revolution/jquery.themepunch.tools.min.js') }}" type="text/javascript"></script>
  <!-- Local Revolution -->
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.migration.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.actions.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.carousel.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.kenburn.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.layeranimation.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.navigation.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.parallax.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.slideanims.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('vendor/revolution/local/revolution.extension.video.min.js') }}"></script>
